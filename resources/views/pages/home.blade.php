...
@section('content')
    ...
    {{-- resumo do dia --}}
    <div class="stat-card stat-card--blue stat-card--split" style="margin-bottom: 12px;">
        <div>
    ...
    <div class="stat-card stat-card--blue stat-grid" style="grid-template-columns: 1fr auto auto; align-items: center; margin-bottom: 24px;">
        <div>
